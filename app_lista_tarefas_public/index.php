	...
	<head>
		...
		<script>
			function editar(id, task){
				...
				//criação do input para inserção do texto
				let inputTarefa = document.createElement('input');
				inputTarefa.type = 'text';
				inputTarefa.name = 'tarefa';
				inputTarefa.className = 'col-9 form-control';
				inputTarefa.value = task;
				...
				//criação do button para o envio do form
			...
			function deletar(id){
				location.href = 'index.php?pag=index&acao=deletar&id='+id;
			}
